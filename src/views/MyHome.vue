  ...
  >
    ...
    <v-container fluid>
      <v-row>
        ...
        <v-col cols="6">
          <h5 class="blue--text text--darken-4 top">gorkemderlerr</h5>
          <h1 class="white--text">Visual Designer</h1>
          <p class="grey--text">
            UI designer for company front-end projects <br />
            <br />
            
          </p>
          <v-btn tile color="rgb(85, 2, 209)" dark> about me </v-btn>
        </v-col>
            ...
            <v-row>
              <v-col cols="12">
                <div class="child bgColor1">
                  <v-icon color="rgb(85, 2, 209)" x-large class="ml-3"
                  ...
                  <v-btn color="rgb(85, 2, 209)" dark text>
                    know more
              ...
              <v-col cols="12" class="mt-10">
                <div class="child1">
                  <h1 class="yellow--text text--darken-4 mt-4 number">12</h1>
                  ...
                  <v-row>
                    <v-col cols="12" class="childcol">
                      <div class="child2 mButton padding bgColor1">
                        <h1 class="yellow--text text--darken-4">60+</h1>
                        <p class="grey--text">Clients</p>
                      </div>
                    </v-col>
                    <v-col cols="12" class="childcol">
                      <div class="child2 padding bgColor1">
                        <h1 class="yellow--text text--darken-4">122+</h1>
                ...
                <div class="child2">
                  <v-row>
                    <v-col cols="12" class="childcol">
                      <div class="child2 mButton padding bgColor1">
                        <h1 class="yellow--text text--darken-4">08</h1>
                        <p class="grey--text">Years Experience</p>
                      </div>
                    </v-col>
                    <v-col cols="12" class="childcol">
                      <div class="child2 padding bgColor1">
                        <h1 class="yellow--text text--darken-4">10</h1>
        ...
        <v-col md="3" offset-md="3" id="about">
          <h4 class="white--text">FEATUyellow PROJECTS</h4>
          <p class="grey--text">Lorem ipsum dolor Lorem ipsum dolor</p>
        </v-col>
        <v-col md="3" class="text-end">
          <v-btn tile color="rgb(85, 2, 209)" dark> View All </v-btn>
        </v-col>
        ...
        <v-col md="3" offset-md="3">
          ...
          <v-btn color="rgb(85, 2, 209)" dark text class="ml-n4">
            know more
            <v-icon right>mdi-arrow-right</v-icon>
          </v-btn>
        </v-col>
        ...
        <v-col md="3" offset-md="3">
          <v-btn color="white" dark text class="ml-n4"> github_gorkemderlerr </v-btn
          ><br />
          ...
          <div class="second">
            <div class="secondchild1" id="contact">
              <v-row>
                ...
                <v-col cols="5">
                  <v-btn tile color="rgb(85, 2, 209)" dark class="mt-16">
                    Contact
                  </v-btn>
                </v-col>
              </v-row>
